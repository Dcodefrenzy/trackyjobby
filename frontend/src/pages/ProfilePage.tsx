        ...
        <div className="profile-container animate-fade-in">
            ...
            <div className="profile-grid">
                ...
                <div className="profile-card instructions-card">
                    ...
                    <div className="safe-forwarding-notice" style={{ background: 'rgba(56, 189, 248, 0.05)', border: '1px solid rgba(56, 189, 248, 0.2)', padding: '16px', borderRadius: '8px', marginBottom: '1.5rem', textAlign: 'left' }}>
                    ...
                    <button
                        ...
                        style={{ width: '100%', justifyContent: 'center', marginBottom: '1rem', background: 'var(--card-hover)', color: 'var(--text-primary)', border: '1px solid var(--border-color)' }}
                    >
                        <Settings size={16} />
                        Open Email Setup Wizard
                    </button>
