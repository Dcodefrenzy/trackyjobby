...
3. If this email IS a job application, set "isJobRelated" to true and extract the following information as structured JSON in the "jobData" field:
   - "companyName": The name of the company the user applied to.
   - "companyDomain": Make an educated guess of the company's primary website domain based on their name and the sender's email (e.g., 'vercel.com', 'stripe.com').
